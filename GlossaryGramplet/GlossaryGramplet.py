    ...
    def init(self):
        ...
        self.render_text(
            _(" 10. %(gramps_FAQ_html_start)s%(faq_section)s"
              ...
              "%(html_end)s\n") % glos_dict)
        glos_dict.update({'web_html_start':
        ...
        self.render_text(
            _(" 12. %(gramps_FAQ_html_start)s%(faq_section)s"
              ...
              "%(html_end)s\n") % glos_dict)
        glos_dict.update({'section': "Portal:Using_GRAMPS'>"})
        self.render_text(
            _(" 13. %(gramps_wiki_html_start)s%(section)s"
              "Is there a manual for Gramps?"
              "%(html_end)s\n") % glos_dict)
        glos_dict.update({'section': "Category:Tutorials'>"})
        self.render_text(
            _(" 14. %(gramps_wiki_html_start)s%(section)s"
              "Are there tutorials available?"
              "%(html_end)s\n") % glos_dict)
        glos_dict.update({'section': "Category:How_do_I...'>"})
        self.render_text(
            _(" 15. %(gramps_wiki_html_start)s%(section)s"
              "How do I ...?"
              "%(html_end)s\n") % glos_dict)
        glos_dict.update({'section': "How_you_can_help'>"})
        self.render_text(
