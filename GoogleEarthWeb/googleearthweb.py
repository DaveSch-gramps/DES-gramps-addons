...
class GoogleEarthWeb(MapService):
    """Map  service using http://maps.earth.google.com"""
    ...
    def calc_url(self):
        ...
        if longitude and latitude:
            self.url = "https://earth.google.com/web/search/%s,%s" % (
                latitude,
                longitude,
            )
            return
        ...
        self.url = "https://earth.google.com/web/search/%s" % "+".join(
            titledescr.split()
        )
